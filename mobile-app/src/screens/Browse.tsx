  ...
  return (
    <div className="flex flex-col screen-enter">
      ...
      <ScreenBody className="gap-4">
        <div className="flex items-center gap-2 rounded-2xl bg-white px-4 py-3 shadow-sm shadow-black/5">
          ...
          {CATEGORY_CHIPS.map((c) => (
            <button
              ...
              className={`shrink-0 rounded-full px-4 py-2 text-xs font-semibold transition-colors ${
                chip === c ? 'bg-relay-green-800 text-relay-cream' : 'bg-white text-relay-muted shadow-sm shadow-black/5'
              }`}
            >
              {c}
            </button>
