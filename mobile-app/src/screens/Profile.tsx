    ...
    <div className="flex flex-col screen-enter">
      ...
      <ScreenBody>
        ...
        <button
          ...
          className="flex items-center justify-between rounded-2xl bg-relay-green-800 p-4 text-left shadow-lg shadow-black/10 transition-transform active:scale-[0.98]"
        >
          <div>
...
function InfoRow({ icon: Icon, label, value }: { icon: LucideIcon; label: string; value: string }) {
  return (
    <div className="flex items-center gap-3 rounded-2xl bg-white p-3.5 shadow-sm shadow-black/5">
